...
<div class="container" style="width: 1000px; margin: auto;">
    ...
    <form id="gameForm" action="process_game.php" method="POST">
        <div class="controls" style="display: flex; flex-direction: row; gap: 20px; justify-content: space-between;">
        ...
        <div class="form-actions">
            ...
            <button type="button" class="secondary" onclick="location.href='../LoadGame/LoadGame.php'">View Saved Games</button>
        </div>
    </form>
</div>
